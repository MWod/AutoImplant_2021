...
Evaluation of Second_Step - Exp 3a.
"""
...
def evaluation():
    experiment_name = "Second_Step_Ev3a"
    ...
    initial_weights_path = str(p.second_step_exp3_save_path/ str("model_cp2"))
    dataset_name = "SS3a_Val"
