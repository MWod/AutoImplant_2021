...
Evaluation of Second_Step - Exp 2.
"""
...
def evaluation():
    experiment_name = "Second_Step_Ev2"
    ...
    initial_weights_path = str(p.second_step_exp2_save_path/ str("model_cp1"))
    dataset_name = "SS2_Val"

    log_dir = p.logs_path / experiments_family / experiment_name
    comment = "Second Step - Exp2"
