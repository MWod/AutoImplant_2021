...
def evaluation():
    experiment_name = "Task1_Ev1"
    experiments_family = "Task1_Evaluation"
    ...
    input_csv = p.task_1_validation_csv_path
    ...
    evaluation_params['dataset_name'] = "T1_Val"
    evaluation_params['data_path'] = data_path
    evaluation_params['model_file'] = unet
    evaluation_params['initial_weights_path'] = str(p.task1_exp1_save_path / str("model_cp3"))
