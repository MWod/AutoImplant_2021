...
Final evaluation of Combined - Exp 2
"""
...
def evaluation():
    echo = True
    output_data_path = p.combined_exp2_results_path
    output_csv_path = p.combined_exp2_results_path / "validation.csv"

    reconstruction_params = dict()
    reconstruction_params['device'] = "cuda:0"
    reconstruction_params['reconstruction_model'] = unet
    reconstruction_params['reconstruction_weights'] = p.combined_exp2_save_path / str("model_cp3")
