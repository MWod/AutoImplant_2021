...
def evaluation():
    echo = True
    output_data_path = p.second_step_exp2a_results_path
    output_csv_path = p.second_step_exp2a_results_path / "validation.csv"
    ...
    reconstruction_params['refinement_weights'] = p.second_step_exp2_save_path / str("model_cp1")
    reconstruction_params['postprocess_refinement'] = False
