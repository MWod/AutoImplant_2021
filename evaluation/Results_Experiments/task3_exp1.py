...
Final evaluation of Task 3 - Exp 1
"""
...
def evaluation():
    echo = True
    output_data_path = p.task3_exp1_results_path
    output_csv_path = p.task3_exp1_results_path / "validation.csv"

    reconstruction_params = dict()
    reconstruction_params['device'] = "cuda:0"
    reconstruction_params['reconstruction_model'] = unet
    reconstruction_params['reconstruction_weights'] = p.task3_exp1_save_path / str("model_cp3")
