...
Training of the implant refinement (with the geometric augmentation).
"""
...
def experiment(current_run):
    ...
    experiment_name = "Second_Step_Exp1"
    ...
    model_save_path = p.second_step_exp1_save_path / str("model_cp" + current_run)

    log_dir = p.logs_path / experiments_family / experiment_name / str("cp_" + current_run)
    comment = "Training of the implant refinement (with the geometric augmentation)."
