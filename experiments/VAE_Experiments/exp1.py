...
"""
TO CHANGE:
1) Maybe complete_implant instead of current version? In theory should be more resistant at boundaries
2) ELBO formulation instad of MSE
"""

def experiment(current_run):
    current_run = str(current_run)

    experiment_name = "VAE_Exp1"
    ...
    model_save_path = p.vae_exp1_save_path / str("model_cp" + current_run)
