...
import training_variational_augmentation as tr
...
def experiment(current_run):
    ...
    experiment_name = "VAE_Exp5"
    experiments_family = "VAE_Experiments"
    ...
    to_load_checkpoint = p.checkpoints_path / experiments_family / "VAE_Exp4" / "cp4" if int(current_run) <= 1 else p.checkpoints_path / experiments_family / experiment_name / str("cp" + str(int(current_run) - 1))
    ...
    model_save_path = p.vae_exp5_save_path / str("model_cp" + current_run)
    # dist_weight = 0.00005
    # dist_weight = 0.0001
    # dist_weight = 0.0003
    dist_weight = 0.001
    ...
    training_params['dist_weight'] = dist_weight
