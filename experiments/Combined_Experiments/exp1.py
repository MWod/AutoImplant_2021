...
Training for combined Task 1/3 (using registration) (with only geometric augmentation).
"""
...
def experiment(current_run):
    ...
    model_save_path = p.combined_exp1_save_path / str("model_cp" + current_run)

    log_dir = p.logs_path / experiments_family / experiment_name / str("cp_" + current_run)
    comment = "Training for combined Task 1/3 (using registration) (with only geometric augmentation)."
